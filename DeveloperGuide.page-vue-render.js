...
with(this){return _c('p',[_v("Refer to the guide ["),_c('em',[_v("Setting up and getting started")]),_v("](SettingUp.md).")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : ["),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")]),_v("]("),_c('a',{attrs:{"href":"https://github.com/se-edu/addressbook-level3/tree/master/src/main/java/seedu/address/model/Model.java"}},[_v("https://github.com/se-edu/addressbook-level3/tree/master/src/main/java/seedu/address/model/Model.java")]),_v(")")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"challenge-2-creating-a-dependency-between-storage-and-fileaccesscommand-for-export-and-import"}},[_v("Challenge 2: Creating a dependency between Storage and FileAccessCommand for export and import"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#challenge-2-creating-a-dependency-between-storage-and-fileaccesscommand-for-export-and-import","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Import and export was initially deemed odd to do since it would have to access "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(", whereas all other commands at the time only needed to have access to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to be executed. Accordingly, we were fairly certain that it would have been inadequate for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export")]),_v(" commands to inherit directly from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(".\nThe workaround our team decided on was to create a new class "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FileAccessCommand")]),_v(" that would require a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" for it's execute which "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import")]),_v(" could then inherit from. As "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FileAccessCommand")]),_v(" inherits from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" this allowed "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import")]),_v(" to continue using the polymorphism when parsing commands and in the LogicManager while having a unique execute to carry out its functions.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 12 Nov 2024, 11:53:07 GMT+8]")])])])}
}];
